...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "next-intl/react": path.resolve(__dirname, "tests/mocks/next-intl.ts"),
      "next-intl/client": path.resolve(__dirname, "tests/mocks/next-intl.ts"),
      "next-intl/server": path.resolve(__dirname, "tests/mocks/next-intl.ts"),
    },
  },
  test: {
    globals: true,
