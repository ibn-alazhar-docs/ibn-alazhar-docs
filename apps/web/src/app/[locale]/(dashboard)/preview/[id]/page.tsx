      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center space-y-4">
          <div className="animate-spin text-4xl">
            <svg className="w-10 h-10 mx-auto text-muted-color" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
          </div>
    ...
    <div className="min-h-screen bg-badge flex flex-col">
      ...
      <div className="border-t border-line bg-card py-4 px-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <span className="text-xs text-very-muted">{tApp("name")} — {t("previewDocument")}</span>
