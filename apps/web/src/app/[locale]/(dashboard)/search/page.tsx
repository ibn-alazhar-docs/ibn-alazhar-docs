          ...
          {loading && (
            <div className="text-center py-8">
              <div className="mb-2 text-muted-color">
                <svg className="w-10 h-10 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
              </div>
              ...
              {results.results.length === 0 ? (
                <div className="text-center py-12">
                  <div className="mb-4 text-muted-color">
                    <svg className="w-12 h-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                  </div>
                  <Text color="muted">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-lg">
                              <svg className="w-5 h-5 text-muted-color" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                            </span>
                          ...
                          <div className="flex items-center gap-3 text-xs text-very-muted">
                            {result.folder && <span><svg className="w-4 h-4 inline text-muted-color" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" /></svg> {result.folder.name}</span>}
                            {result.pageCount && (
                              <span>
                                {result.pageCount} {tDocs("pageCount")}
                              </span>
                            )}
                            {result.wordCount && <span>{result.wordCount.toLocaleString(locale === "ar" ? "ar-EG" : "en-US")}</span>}
                            <span>
