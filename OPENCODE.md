...
The `.agents/` directory may be generated by external skill installers for other agents, but it is not part of the canonical OpenCode workflow unless explicitly approved.
