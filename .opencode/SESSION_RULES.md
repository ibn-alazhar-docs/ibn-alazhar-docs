...
1. Load `SYSTEM.md`.
2. Load `prompts/system/runtime-system-prompt.md`.
3. Hydrate memory (`memory/`).
4. Detect active phase (`runtime/runtime-status.md`).
5. Load agent roster (`agents/`).
6. Run health checks (`runtime/runtime-health.md`).
