...
## السياق (Context)
التعرف البصري على الحروف (OCR) هو ميزة جوهرية في منصة مستند / DocEd. المستخدمون يحتاجون لتحويل المستندات المكتوبة باللغة العربية إلى نص قابل للبحث والنسخ. جودة OCR للعربية تعتبر تحديًا خاصًا لأن اللغة العربية لها خصائص فريدة: اتصال الحروف، أشكال متعددة لكل حرف، تشكيل (حركات)، واتجاه الكتابة من اليمين لليسار. معظم محركات OCR المفتوحة المصدر تقدم جودة متوسطة للعربية. نحتاج إلى قرار مرحلي: ماذا نستخدم في MVP (الحد الأدنى المنتج)، وماذا نستخدم في الإصدارات المستقبلية.
