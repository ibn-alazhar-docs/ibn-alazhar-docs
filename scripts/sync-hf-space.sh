...
# NOTE: logo.svg now embeds the exact institutional logo as base64-encoded PNG,
# so it's the canonical logo asset. logo.png is kept locally but NOT shipped to
# HF (binary file rejection).
